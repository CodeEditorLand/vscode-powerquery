...
export function createDocumentSemanticTokensProvider(
	...
	return {
		provideDocumentSemanticTokens: (
			...
			debouncedSemanticTokenRequester(
				client,
				textDocument,
				cancellationToken
			),
...
async function semanticTokenRequester(
	...
	const semanticTokens: PQLS.PartialSemanticToken[] =
		await client.sendRequest<PQLS.PartialSemanticToken[]>(
	...
	const tokenBuilder: vscode.SemanticTokensBuilder =
		new vscode.SemanticTokensBuilder(SemanticTokensLegend);
