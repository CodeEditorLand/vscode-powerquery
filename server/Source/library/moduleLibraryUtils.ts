...
export function onModuleAdded(
	uri: string,
	moduleSymbols: ReadonlyArray<PQLS.LibrarySymbol.LibrarySymbol>,
): void {
	moduleLibraryByUri.set(
		uri,
		LibrarySymbolUtils.toLibraryDefinitions(moduleSymbols),
	);
}
